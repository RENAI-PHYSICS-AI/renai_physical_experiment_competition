...
SPEC = importlib.util.spec_from_file_location("lissajous_launcher_lifecycle", PACKAGING_DIR / "launcher.py")
...
class LauncherLifecycleTests(unittest.TestCase):
    ...
    def test_named_job_child_attaches_before_descendants(self) -> None:
        ...
        job_name = f"LissajousTestJob_{os.getpid()}_{uuid.uuid4().hex}"
        ack_path = Path(tempfile.gettempdir()) / f"lissajous_test_ack_{uuid.uuid4().hex}.txt"
    ...
    def test_managed_browser_exit_waits_for_connection_to_close(self) -> None:
        ...
        with (
            ...
            reason = launcher.monitor_browser(app_process, launcher.HeartbeatState(), 8501, session)
    ...
    def test_managed_browser_exit_after_connection_closes(self) -> None:
        ...
        with (
            ...
            reason = launcher.monitor_browser(app_process, state, 8501, session)
    ...
    def test_managed_browser_early_exit_is_startup_failure(self) -> None:
        ...
        with (
            ...
            reason = launcher.monitor_browser(
                app_process, launcher.HeartbeatState(), 8501, session
            )
    ...
    def test_open_browser_uses_isolated_app_profile(self) -> None:
        ...
        with (
            ...
            session = launcher.open_browser("http://127.0.0.1:8501")
